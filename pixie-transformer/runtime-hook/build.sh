...
output="$output_dir/PixieTransformerRuntime.dll"
object="$output_dir/runtime-pixie-transformer.o"
...
"$zig" c++ \
  ...
  -c \
  -o "$object" \
  "$script_dir/runtime-pixie-transformer.cpp"
